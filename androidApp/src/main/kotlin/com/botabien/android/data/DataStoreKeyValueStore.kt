...
private val Context.botaBienPreferences: DataStore<Preferences> by preferencesDataStore(
    name = "botabien_preferences",
)
...
class DataStoreKeyValueStore(
    ...
    override suspend fun read(key: String): String? =
        context.botaBienPreferences.data.first()[stringPreferencesKey(key)]

    override suspend fun write(key: String, value: String) {
        context.botaBienPreferences.edit { preferences ->
