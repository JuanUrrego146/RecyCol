...
| Open Images V7 (subset dirigido) | Anotaciones CC BY 4.0 · imágenes listadas CC BY 2.0 con advertencia de verificación individual | [Ficha oficial](https://storage.googleapis.com/openimages/web/factsfigures_v7.html) | **APTO CON FILTRADO por imagen** (mismo mecanismo que TACO). Recortes de bbox de clases dirigidas: Mobile phone, Laptop, Remote control, Calculator, Camera, Headphones, Corded phone → `ELECTRONIC`; Tin can → `METAL`; Coffee cup → `BEVERAGE_CARTON` **con curación manual por muestreo** (la clase mezcla vasos desechables con tazas de cerámica) |
